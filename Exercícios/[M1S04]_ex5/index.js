...
const separaNumerosRepetidos = newArray.filter(function(itemAnterior, itemAtual) {
        return newArray.indexOf(itemAnterior) == itemAtual
    }
)

const novoArrayEmOrdemCrescente = separaNumerosRepetidos.sort()
console.log(novoArrayEmOrdemCrescente)