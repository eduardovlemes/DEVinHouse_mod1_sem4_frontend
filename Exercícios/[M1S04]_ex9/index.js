...
arrayMusicas.map((atributoDoObjeto) => {
  atributoDoObjeto.isGood = true
})

arrayMusicas.forEach((atributoDoObjeto) => {
  const listaNaoOrdenadaInseridaNoHTML = document.createElement("li")
  listaNaoOrdenadaInseridaNoHTML.innerHTML += atributoDoObjeto.nome
  Div.appendChild(listaNaoOrdenadaInseridaNoHTML)
});
